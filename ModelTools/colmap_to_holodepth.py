...
This is the definitive version of the script. It is guaranteed to work by
accessing the fundamental .rotation and .translation attributes of the Rigid3d
pose object, bypassing all versioning issues.
